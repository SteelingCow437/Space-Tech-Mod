...
public class AlloyFurnaceScreen extends AbstractContainerScreen<AlloyFurnaceMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Spacetechmod.MOD_ID, "textures/gui/alloy_furnace_gui.png");
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y) {
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 10, y + 33, 176, 0, 0, menu.getScaledProgress());
        }
    }
