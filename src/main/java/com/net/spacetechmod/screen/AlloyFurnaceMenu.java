...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    ...
    public AlloyFurnaceMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 24, 30));
            this.addSlot(new SlotItemHandler(handler, 2, 36, 45));
        });
        addDataSlots(data);
    }
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 3; //# of slots in machine
    @Override
